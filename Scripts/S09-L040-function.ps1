...
Enter the message
.EXAMPLE
.\Send-EmailFromGmail -EmailTo user@domain.com, -Subject "Hi there" -Body "Have a nice day" -Verbose
#>
...
Send-EmailFromGmail -EmailTo username@mobilo24.eu -Subject "Test function" -verbose